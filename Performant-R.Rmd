...
How do you _find_ the slow part of your code? 
...
for many kinds of jobs, but at a cost: getting access to those systems,
learning about queue submission, paying for computational jobs,
implementing post-processing, using MPI if needed, etc.
